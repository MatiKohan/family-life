    ...
    en: {
      translation: {
        ...
        home: {
          ...
          leftoverItems: 'Leftover groceries',
          leftoverCount: '{{count}} leftover items',
        ...
        calendar: {
          ...
          copyLink: 'Copy link',
          linkCopied: 'Copied!',
          regenerateToken: 'Reset link',
          regenerateConfirm: 'This will invalidate the current subscription link. Continue?',
          rsvpTitle: "Who's coming",
          rsvp_going: 'Going',
          rsvp_maybe: 'Maybe',
          rsvp_no: "Can't go",
          bringing: 'Bringing',
